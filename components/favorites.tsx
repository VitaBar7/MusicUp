...
export default function Favorites () {
    ...
    return (
        <>
          ...
          <h2 className="z-10 relative text-xl mt-6 pl-2 lg:text-xl lg:mt- md:self-start md:mt-10 ml-2 md:ml-0  sm:text-2xl sm:self-center  xs:text-md xs:max-sm:mt-4 xs:max-sm:mb-24 xs:self-start xs:text-[1.3rem] tracking-wider text-white">Your favorites:</h2>
            {favorites?.map((item) => {
              return (
                <>
